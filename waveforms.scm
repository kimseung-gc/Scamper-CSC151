...
;; Authors: Seunghyeon Kim & Muhammad Khalid
;; Date: 31/10/2022
;; Acknowledgements:
...
(define waves-per-clip
  (lambda (duration frequency)
    (* duration frequency)))

(test-case "waves-per-clip example 1"
  (=-eps 0.01) (waves-per-clip 1 middle-c) 261.63)

(test-case "waves-per-clip example 2"
  (=-eps 0.01) (waves-per-clip 2 a4) 880.0)

(test-case "waves-per-clip example 3"
  (=-eps 0.01) (waves-per-clip 60 bf5) 55939.8)
...
(sawtooth-sample medium-quality middle-c 1)
...
(triangle-sample medium-quality middle-c 1)
...
(sine-sample medium-quality middle-c 1)